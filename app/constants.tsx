...
export const screens: Screen[] = [
  ...
  { name: 'Loader', route: '(tabs)/loader', info: 'This advanced component combines React Native Reanimated\'s animation capabilities with Skia\'s powerful rendering to create a visually striking spinning loader.\n\nBy leveraging Reanimated\'s shared values and derived values, developers can seamlessly integrate complex animations into their React Native applications. The component demonstrates the use of Skia\'s Canvas, Path, and Gradient features to render a smooth, continuously rotating circle with dynamic color transitions.\n\nIt incorporates 3D transformations and interpolated values to add depth and variability to the animation. This technique elevates the user experience by transforming a standard loading indicator into a visually rich, performant animation, showcasing the powerful capabilities of combining Skia\'s advanced rendering with Reanimated\'s fluid animation system in React Native.' },
  { name: 'Microphone Button', route: '(tabs)/microphoneButton', info: 'This advanced component combines React Native Gesture Handler\'s touch capabilities with Skia\'s powerful rendering to create an interactive and visually striking button.\n\nBy leveraging Reanimated\'s shared values and derived values, developers can seamlessly integrate complex animations into their React Native applications. The component demonstrates the use of Skia\'s Canvas, Path, and Group features to render concentric circles that respond to user interactions. It incorporates scale transformations and opacity changes to add depth and dynamism to the animation.\n\nThis technique elevates the user experience by transforming a standard button into a visually rich, performant animation, showcasing the powerful capabilities of combining Skia\'s advanced rendering with Reanimated\'s fluid animation system in React Native.' },
];
